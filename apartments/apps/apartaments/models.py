...
class Apartament(Sortable):
    ...
    fromMonte = models.IntegerField()
    fromBeach = models.IntegerField()
    ...
    teaserPicture = models.ImageField(_('Teaser Picture'),
    ...
    def save(self, *args, **kwargs):
        ...
        if len(reservation.models.PriceSettings.objects.all().filter(apartament = self))==0:
            settings = reservation.models.PriceSettings()
            settings.apartament = self
            settings.price = self.priceHigh
            settings.save()
